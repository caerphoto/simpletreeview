...
Here's an example one, randomly generated by the included domspeedtest page:

![simple tree view example](http://andyf.me/media/misc/simpletreeview-example.png)

## Dependencies

STV requires [Underscore.js](http://underscorejs.org/), at minimum, or
[lodash](https://lodash.com/) might also work. [jQuery](http://jquery.com/) is
also required for event handling and some DOM manipulation.
